...
const SHEET_ID = "1hdGFJcJzS5MkbeOrBVf3jQ13URViWkZjrj9GEGHzz8M";
const SHEET_NAME = "Meta Ads Report";

async function SolarAdsTask() {
  const accountId = process.env.SOLAR_ACC_ID;
